...
### [필수] 날씨 모델
```dart
// 파일: lib/data/models/weather_model.dart
...
### [필수] 날씨 배경 위젯
```dart
// 파일: lib/presentation/screens/splash/widgets/weather_background.dart
import 'package:flutter/material.dart';
import '../../../../data/models/weather_model.dart';
...
### [필수] 바로가기 버튼
```dart
// 파일: lib/presentation/screens/splash/widgets/feed_shortcut_button.dart
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
...
### [선택] 특별 알림 효과
```dart
// 파일: lib/presentation/screens/splash/widgets/special_event_overlay.dart
